        ...
        <section className="relative py-14">
            <div className="relative z-10 max-w-screen-xl mx-auto px-4 md:px-8">
                <div className="max-w-xl sm:text-center md:mx-auto">
                    ...
                    <p className="mt-3 text-gray-600 font-sans text-lg">
                                ...
                                <li key={idx} className="bg-white rounded-xl border shadow-md">
                                    ...
                                    <figure>
                                        ...
                                        <div className="flex items-center gap-x-4 p-4 mt-6 bg-indigo-50">
                                            <img src={item.avatar} className="w-16 h-16 rounded-full border-2 border-indigo-500" alt="avatar" />
                                            <div>
            ...
            <div className="absolute top-0 w-full h-[350px] bg-blue-200/50"></div>
        </section>
    )
}